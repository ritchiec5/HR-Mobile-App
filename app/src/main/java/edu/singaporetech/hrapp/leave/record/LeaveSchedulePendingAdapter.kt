...
/**
 * Class that connects the Pending Leaves Recyclerview to the LeaveScheduleFragment
 * @return RecyclerView.Adapter<LeaveSchedulePendingAdapter.ViewHolder>
 */
class LeaveSchedulePendingAdapter() : RecyclerView.Adapter<LeaveSchedulePendingAdapter.ViewHolder>() {
     ...
     * @param i position that the item in the recyclerview is deleted at
     */
    fun deleteItem(i: Int) {
        leaveList.removeAt(i)
    ...
    /**
     * Function that retrieves data into the leavelist
     * @return leaveList
     */
     ...
     */
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LeaveSchedulePendingAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.pending_schedule_item, parent, false)
        return ViewHolder(v, mListener)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (currentItem.status == "Approved" || currentItem.status == "Declined"){
            ...
            val LayoutParamsPending = RecyclerView.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT
            )
            LayoutParamsPending.setMargins(10, 10, 10, 10)
            holder.itemView.setLayoutParams(LayoutParamsPending)
        }
    }
